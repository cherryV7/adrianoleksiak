                        ...
                        <div id="navbar" className={ this.state.isOpen ? "navbar-collapse navigation-holder active" : "navbar-collapse navigation-holder"}>
                            ...
                            <ul className="nav navbar-nav">
                                ...
                                <li className="service">
                                    <Link activeClass="active" to="service" spy={true} smooth={true}  duration={500}>Co robię</Link>
                                </li>
                                <li className="protfolio">
                                    <Link activeClass="active" to="portfolio" spy={true} smooth={true}  duration={500}>Jak się bawimy</Link>
                                </li>
                                <li className="blog">
